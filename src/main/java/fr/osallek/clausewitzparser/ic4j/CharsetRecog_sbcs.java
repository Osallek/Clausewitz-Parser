...
abstract class CharsetRecog_sbcs extends CharsetRecognizer {
    ...
    static class NGramParser_IBM420 extends NGramParser {
        ...
        private int nextByte(CharsetDetector det) {
            ...
            if (this.alef != (byte) 0x00) {
                next = 0xB1 & 0xFF;
            } else {
                next = this.unshapeMap[det.fInputBytes[this.byteIndex] & 0xFF] & 0xFF;
            }
    ...
    static class CharsetRecog_8859_1 extends CharsetRecog_sbcs {
        ...
        public CharsetMatch match(CharsetDetector det) {
            ...
            String lang = null;
            for (NGramsPlusLang ngl : this.ngrams_8859_1) {
                int confidence = match(det, ngl.fNGrams, this.byteMap);
    ...
    static class CharsetRecog_8859_2 extends CharsetRecog_sbcs {
        ...
        public CharsetMatch match(CharsetDetector det) {
            ...
            int bestConfidenceSoFar = -1;
            String lang = null;
            for (NGramsPlusLang ngl : this.ngrams_8859_2) {
                int confidence = match(det, ngl.fNGrams, this.byteMap);
                if (confidence > bestConfidenceSoFar) {
                    bestConfidenceSoFar = confidence;
                    lang = ngl.fLang;
    ...
    static class CharsetRecog_8859_5_ru extends CharsetRecog_8859_5 {
        ...
        @Override
        public CharsetMatch match(CharsetDetector det) {
            int confidence = match(det, this.ngrams, this.byteMap);
    ...
    static class CharsetRecog_8859_8_I_he extends CharsetRecog_8859_8 {
        ...
        private static int[] ngrams = {0x20E0E5, 0x20E0E7, 0x20E0E9, 0x20E0FA, 0x20E1E9, 0x20E1EE, 0x20E4E0, 0x20E4E5, 0x20E4E9, 0x20E4EE, 0x20E4F2, 0x20E4F9, 0x20E4FA, 0x20ECE0, 0x20ECE4, 0x20EEE0, 0x20F2EC, 0x20F9EC, 0xE0FA20, 0xE420E0, 0xE420E1, 0xE420E4, 0xE420EC, 0xE420EE, 0xE420F9, 0xE4E5E0, 0xE5E020, 0xE5ED20, 0xE5EF20, 0xE5F820, 0xE5FA20, 0xE920E4, 0xE9E420, 0xE9E5FA, 0xE9E9ED, 0xE9ED20, 0xE9EF20, 0xE9F820, 0xE9FA20, 0xEC20E0, 0xEC20E4, 0xECE020, 0xECE420, 0xED20E0, 0xED20E1, 0xED20E4, 0xED20EC, 0xED20EE, 0xED20F9, 0xEEE420, 0xEF20E4, 0xF0E420, 0xF0E920, 0xF0E9ED, 0xF2EC20, 0xF820E4, 0xF8E9ED, 0xF9EC20, 0xFA20E0, 0xFA20E1, 0xFA20E4, 0xFA20EC, 0xFA20EE, 0xFA20F9,};
    ...
    static class CharsetRecog_8859_8_he extends CharsetRecog_8859_8 {
        ...
        private static int[] ngrams = {0x20E0E5, 0x20E0EC, 0x20E4E9, 0x20E4EC, 0x20E4EE, 0x20E4F0, 0x20E9F0, 0x20ECF2, 0x20ECF9, 0x20EDE5, 0x20EDE9, 0x20EFE5, 0x20EFE9, 0x20F8E5, 0x20F8E9, 0x20FAE0, 0x20FAE5, 0x20FAE9, 0xE020E4, 0xE020EC, 0xE020ED, 0xE020FA, 0xE0E420, 0xE0E5E4, 0xE0EC20, 0xE0EE20, 0xE120E4, 0xE120ED, 0xE120FA, 0xE420E4, 0xE420E9, 0xE420EC, 0xE420ED, 0xE420EF, 0xE420F8, 0xE420FA, 0xE4EC20, 0xE5E020, 0xE5E420, 0xE7E020, 0xE9E020, 0xE9E120, 0xE9E420, 0xEC20E4, 0xEC20ED, 0xEC20FA, 0xECF220, 0xECF920, 0xEDE9E9, 0xEDE9F0, 0xEDE9F8, 0xEE20E4, 0xEE20ED, 0xEE20FA, 0xEEE120, 0xEEE420, 0xF2E420, 0xF920E4, 0xF920ED, 0xF920FA, 0xF9E420, 0xFAE020, 0xFAE420, 0xFAE5E9,};
    ...
    static class CharsetRecog_IBM424_he_rtl extends CharsetRecog_IBM424_he {
        ...
        private static final int[] ngrams = {0x404146, 0x404148, 0x404151, 0x404171, 0x404251, 0x404256, 0x404541, 0x404546, 0x404551, 0x404556, 0x404562, 0x404569, 0x404571, 0x405441, 0x405445, 0x405641, 0x406254, 0x406954, 0x417140, 0x454041, 0x454042, 0x454045, 0x454054, 0x454056, 0x454069, 0x454641, 0x464140, 0x465540, 0x465740, 0x466840, 0x467140, 0x514045, 0x514540, 0x514671, 0x515155, 0x515540, 0x515740, 0x516840, 0x517140, 0x544041, 0x544045, 0x544140, 0x544540, 0x554041, 0x554042, 0x554045, 0x554054, 0x554056, 0x554069, 0x564540, 0x574045, 0x584540, 0x585140, 0x585155, 0x625440, 0x684045, 0x685155, 0x695440, 0x714041, 0x714042, 0x714045, 0x714054, 0x714056, 0x714069,};

        @Override
        public CharsetMatch match(CharsetDetector det) {
            int confidence = match(det, this.ngrams, this.byteMap, (byte) 0x40);
            return confidence == 0 ? null : new CharsetMatch(det, this, confidence);
        }
    }
    ...
    static class CharsetRecog_IBM424_he_ltr extends CharsetRecog_IBM424_he {
        ...
        private static final int[] ngrams = {0x404146, 0x404154, 0x404551, 0x404554, 0x404556, 0x404558, 0x405158, 0x405462, 0x405469, 0x405546, 0x405551, 0x405746, 0x405751, 0x406846, 0x406851, 0x407141, 0x407146, 0x407151, 0x414045, 0x414054, 0x414055, 0x414071, 0x414540, 0x414645, 0x415440, 0x415640, 0x424045, 0x424055, 0x424071, 0x454045, 0x454051, 0x454054, 0x454055, 0x454057, 0x454068, 0x454071, 0x455440, 0x464140, 0x464540, 0x484140, 0x514140, 0x514240, 0x514540, 0x544045, 0x544055, 0x544071, 0x546240, 0x546940, 0x555151, 0x555158, 0x555168, 0x564045, 0x564055, 0x564071, 0x564240, 0x564540, 0x624540, 0x694045, 0x694055, 0x694071, 0x694540, 0x714140, 0x714540, 0x714651
    ...
    static class CharsetRecog_IBM420_ar_rtl extends CharsetRecog_IBM420_ar {
        ...
        private static final int[] ngrams = {0x4056B1, 0x4056BD, 0x405856, 0x409AB1, 0x40ABDC, 0x40B1B1, 0x40BBBD, 0x40CF56, 0x564056, 0x564640, 0x566340, 0x567540, 0x56B140, 0x56B149, 0x56B156, 0x56B158, 0x56B163, 0x56B167, 0x56B169, 0x56B173, 0x56B178, 0x56B19A, 0x56B1AD, 0x56B1BB, 0x56B1CF, 0x56B1DC, 0x56BB40, 0x56BD40, 0x56BD63, 0x584056, 0x624056, 0x6240AB, 0x6240B1, 0x6240BB, 0x6240CF, 0x634056, 0x734056, 0x736240, 0x754056, 0x756240, 0x784056, 0x9A4056, 0x9AB1DA, 0xABDC40, 0xB14056, 0xB16240, 0xB1DA40, 0xB1DC40, 0xBB4056, 0xBB5640, 0xBB6240, 0xBBBD40, 0xBD4056, 0xBF4056, 0xBF5640, 0xCF56B1, 0xCFBD40, 0xDA4056, 0xDC4056, 0xDC40BB, 0xDC40CF, 0xDC6240, 0xDC7540, 0xDCBD40,};
        ...
        @Override
        public CharsetMatch match(CharsetDetector det) {
            int confidence = matchIBM420(det, this.ngrams, this.byteMap, (byte) 0x40);
            return confidence == 0 ? null : new CharsetMatch(det, this, confidence);
        }
